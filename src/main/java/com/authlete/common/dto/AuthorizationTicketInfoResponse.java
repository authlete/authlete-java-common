...
/**
 * Response from Authlete's {@code /auth/authorization/ticket/info} API.
 *
 * <p>
...
public class AuthorizationTicketInfoResponse extends ApiResponse
{
    ...
    /**
     * Get the result of the {@code /auth/authorization/ticket/info} API call.
     *
     * @return
    ...
    /**
     * Set the result of the {@code /auth/authorization/ticket/info} API call.
     *
     * @param action
     *         The result of the API call.
     *
     ...
     *         {@code this} object.
     */
    public AuthorizationTicketInfoResponse setAction(Action action)
    {
        this.action = action;
