...
public class DeviceAuthorizationResponse extends ApiResponse
{
     ...
     *      OAuth Client ID Metadata Document</a>
     */
    public DeviceAuthorizationResponse setMetadataDocumentLocation(URI location)
    {
     ...
     *      OAuth Client ID Metadata Document</a>
     */
    public DeviceAuthorizationResponse setMetadataDocumentUsed(boolean used)
    {
     ...
     * device authorization endpoint should add the
