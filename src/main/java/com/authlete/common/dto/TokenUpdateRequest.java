 ...
 * </p>
 * <p>The value of the {@code accessToken} parameter takes precedence.</p>
 * </dd>
 *
 * <dt><b><code>accessTokenValueUpdated</code></b></dt>
 * <dd>
 * <p>
 * A boolean request parameter which indicates whether to update the value of the access token in the data store. If
 * this parameter is set to {@code true} then a new access token value is 
 * generated by the server and returned in the response. The default value is {@code false} 
 * and the access token's previous value is retained.
 * </p>
 * </dd>
 *
 * </dl>
